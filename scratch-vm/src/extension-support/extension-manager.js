...
const builtinExtensions = {
    ...
    tmsound: () => require('../extensions/scratch3_tmsound'),
    httpapi: () => require('../extensions/scratch3_httpapi'),
    videoSensing: () => require('../extensions/scratch3_video_sensing'),
    ev3: () => require('../extensions/scratch3_ev3'),
    makeymakey: () => require('../extensions/scratch3_makeymakey'),
    boost: () => require('../extensions/scratch3_boost'),
    gdxfor: () => require('../extensions/scratch3_gdx_for'),
    easyplug: () => require('../extensions/scratch3_easyplug'),
    maqueen: () => require('../extensions/scratch3_maqueen'),
    tmimage: () => require('../extensions/scratch3_tmimage'),
