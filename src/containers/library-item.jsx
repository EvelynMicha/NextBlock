...
const defaultAssetHost = 'https://assets.scratch.mit.edu';
...
class LibraryItem extends React.PureComponent {
    ...
    render () {
        ...
        const assetHost = storage.assetHost || defaultAssetHost;
        const iconURL = this.props.iconRawURL ?
            this.props.iconRawURL :
            (iconMd5 ? `${assetHost}/internalapi/asset/${iconMd5}/get/` : null);
        return (
