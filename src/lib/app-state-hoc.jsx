...
const AppStateHOC = function (WrappedComponent, localesOnly) {
    class AppStateWrapper extends React.Component {
        constructor (props) {
            ...
            // Default UI locale to Greek ('el'); allow override via browser/URL if different.
            let initializedLocales = initLocale(localesInitialState, 'el');
            const locale = detectLocale(Object.keys(locales));
            if (locale && locale !== 'el') {
                initializedLocales = initLocale(localesInitialState, locale);
            }
            if (localesOnly) {
