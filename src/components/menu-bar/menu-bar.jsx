...
import {openTipsLibrary, openSnippetLibrary, openDebugModal} from '../../reducers/modals';
...
import scratchLogo from './nextblock-logo.png';
...
const ariaMessages = defineMessages({
    ...
    snippets: {
        id: 'gui.menuBar.snippetsLibrary',
        defaultMessage: 'Βιβλιοθήκη κώδικα',
        description: 'accessibility text for the snippets button'
    },
    debug: {
            ...
            >
                <div className={styles.mainMenu}>
                    ...
                    <div className={styles.fileGroup}>
                        ...
                        <div
                            aria-label={this.props.intl.formatMessage(ariaMessages.snippets)}
                            className={classNames(styles.menuBarItem, styles.noOffset, styles.hoverable)}
                            onClick={this.props.onOpenSnippetLibrary}
                        >
                            <img
                                className={styles.helpIcon}
                                src={helpIcon}
                            ...
                            <span className={styles.debugLabel}>
                                <FormattedMessage {...ariaMessages.snippets} />
                            </span>
                        </div>
                        <div
...
MenuBar.propTypes = {
    ...
    onOpenSnippetLibrary: PropTypes.func,
...
const mapDispatchToProps = dispatch => ({
    ...
    onOpenSnippetLibrary: () => dispatch(openSnippetLibrary()),
