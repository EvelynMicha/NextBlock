...
const MODAL_SNIPPET_LIBRARY = 'snippetLibrary';
...
const openSnippetLibrary = function () {
    return openModal(MODAL_SNIPPET_LIBRARY);
};
...
const closeSnippetLibrary = function () {
    return closeModal(MODAL_SNIPPET_LIBRARY);
};
